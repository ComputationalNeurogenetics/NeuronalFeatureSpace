...
R1.GABA.e14.data <- subset(s.data.e14, idents=c(119,60,105))
...
row_ha <- rowAnnotation(scATAC.cluster = Idents(R1.GABA.e14.data), col = list(scATAC.cluster = c("119" = "red","60" = "steelblue", "105" = "orange")))
