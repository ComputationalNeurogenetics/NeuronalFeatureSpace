...
s.data.e14 <- qread("../scATAC_data/E14_DownstreamReady.071222.RNA.pos.idents.qss", nthreads = 6)
```
...
#GABA.prog.e14.data <- subset(s.data.e14, idents=intersect(seq(1:130)[which(nt.type.prop["GABAergic neurons",]>0.75 | nt.type.prop["progenitor",]>0.5)], reliable.clusters))

GABA.prog.e14.data <- subset(s.data.e14, idents= intersect(c(c(which(nt.type.prop["GABAergic neurons",]>0.75),c(104,21,23,69,95,90,54,118))), reliable.clusters))

# opt1
GABA.prog.e14.data <- subset(s.data.e14, idents= intersect(c(c(which(nt.type.prop["GABAergic neurons",]>0.75),c(90,21,95,69,118,54))), reliable.clusters))
...
# Test with serot
GABA.prog.e14.data <- subset(s.data.e14, idents= intersect(c(c(which(nt.type.prop["GABAergic neurons",]>0.75),c(90,21,12,64))), reliable.clusters))
```
...
Combined.brain.E14.cCREs <- readRDS(file="../../mm10/Combined.brain.E14.cCREs.Rds")
DefaultAssay(s.data.e14) <- "peaks"
