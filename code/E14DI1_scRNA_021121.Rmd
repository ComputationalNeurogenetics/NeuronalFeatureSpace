...
```{r Reading datafiles and form Seurat objects}
  repl1 <- Read10X(data.dir = "/Volumes/ExtSSD/ExtraWorkspace/e14di_data/scRNA/E14_DI_1_RNA/outs/filtered_feature_bc_matrix/", gene.column = 1)
  s.repl1 <- CreateSeuratObject(counts = repl1, project = "repl1")

  repl2 <- Read10X(data.dir = "/Volumes/ExtSSD/ExtraWorkspace/e14di_data/scRNA/E14_DI_2_RNA/outs/filtered_feature_bc_matrix/", gene.column = 1)
...
feature.data.repl1 <- as.data.frame(setNames(fread("/Volumes/ExtSSD/ExtraWorkspace/e14di_data/scRNA/E14_DI_1_RNA/outs/filtered_feature_bc_matrix/features.tsv.gz", header=FALSE), c("ensg_id","gene_name","exp_type")))

feature.data.repl2 <- as.data.frame(setNames(fread("/Volumes/ExtSSD/ExtraWorkspace/e14di_data/scRNA/E14_DI_2_RNA/outs/filtered_feature_bc_matrix/features.tsv.gz", header=FALSE), c("ensg_id","gene_name","exp_type")))
```
...
s.data_RNA <- subset(s.data_RNA, subset = nFeature_RNA > 3000 & nFeature_RNA < 5500 & percent.mt < 15)
```
