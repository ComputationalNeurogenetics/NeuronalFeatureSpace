...
obj <- qread("../NeuronalFeatureSpace/scATAC_data/E14_scATAC_integrated.310723.qs",nthreads = 4)
...
npcs <- 2:57
resolutions <- 10# seq(1,20,by=1)
assay <- "peaks"
reduction <- "lsi"
results_path <- "results_E14_scATAC_220823/"
