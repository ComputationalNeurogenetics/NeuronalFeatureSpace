...
```{r Draw circos plot, fig.height=24, fig.width=24}
...
ggplot(tibble(overlap=percentOverlap),aes(x=overlap)) + geom_histogram(colour="black", fill=pal_jco()(6)[6]) + theme_minimal() + xlab("Overlap proportion") + ggtitle("Hist. of E14di separate feature space feature overlaps with the joint one")
...
ggplot(tibble(overlap=percentOverlap),aes(x=overlap)) + geom_histogram(colour="black", fill=pal_jco()(6)[6]) + theme_minimal() + xlab("Overlap proportion") + ggtitle("Hist. of joint feature space feature overlaps with the E14DI separate one")
```
