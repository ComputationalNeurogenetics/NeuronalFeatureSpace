...
ggplot(tibble(feat.widths=log10(ranges(clade.peaks)@width)),aes(x=feat.widths)) + geom_histogram(bins=50) + theme_minimal() + xlab("Feature length in bp") + ylab("Count") 0+ theme(text = element_text(size=20)) + scale_x_continuous(breaks = seq(0, 6000, by = 500))
