...
ggplot(feat.widths,aes(x=feat.widths)) + geom_boxplot(fill="grey", outlier.shape = NA) + theme_minimal() + theme(text = element_text(size=30),axis.ticks.y = element_blank(),axis.text.y = element_blank()) + xlab("Feature length") + scale_x_continuous(limits = quantile(feat.widths$feat.widths, c(0.1, 0.9)))
```
