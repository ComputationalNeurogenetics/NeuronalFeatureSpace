---
title: "E14vR1 scRNA analysis with process and parameters standardized with rV2 project"
...
```{r Reading datafiles and form Seurat objects}
  repl1 <- Read10X(data.dir = "/Volumes/ExtSSD/ExtraWorkspace/e14vr1_data/scRNA/E14vR1_1_RNA/outs/filtered_feature_bc_matrix/", gene.column = 1)
  s.repl1 <- CreateSeuratObject(counts = repl1, project = "repl1")

  repl2 <- Read10X(data.dir = "/Volumes/ExtSSD/ExtraWorkspace/e14vr1_data/scRNA/E14vR1_2_RNA/outs/filtered_feature_bc_matrix/", gene.column = 1)
...
feature.data.repl1 <- as.data.frame(setNames(fread("/Volumes/ExtSSD/ExtraWorkspace/e14vr1_data/scRNA/E14vR1_1_RNA/outs/filtered_feature_bc_matrix/features.tsv.gz", header=FALSE), c("ensg_id","gene_name","exp_type")))

feature.data.repl2 <- as.data.frame(setNames(fread("/Volumes/ExtSSD/ExtraWorkspace/e14vr1_data/scRNA/E14vR1_2_RNA/outs/filtered_feature_bc_matrix/features.tsv.gz", header=FALSE), c("ensg_id","gene_name","exp_type")))
```
