...
s.data <- qread("../scRNA_data/E14_scRNA_for_chooseR_280623.qs", nthreads=2)
...
std.proportion.pca <- sapply(1:length(s.data@reductions$pca@stdev),function(x){s.data@reductions$pca@stdev[x]/s.data@reductions$pca@stdev[1]})
